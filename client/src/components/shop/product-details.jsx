...
import { setProductDetails } from "@/store/shop-slice/productsSlice";
import { Label } from "../ui/label";
import StarRatingComponent from "../starRating";
import { useEffect, useState } from "react";
import { addReview, getReviews } from "@/store/shop-slice/reviewSlice.js";
...
const ProductDetailsDialog = ({ open, setOpen, productDetails }) => {
    ...
    const { user } = useSelector((state) => state.shopAuth);
